...
HECHOS_SEMILLA: list[tuple[str, str, str]] = [
    ...
    ("procesamiento_multimodal", "es_parte_de", "valeria"),
    ("procesamiento_multimodal", "tiene_funcion", "normalizar texto imagen y audio para el razonamiento"),
    ("agente_percepcion", "tiene_funcion", "unificar entradas multimodales en texto para razonar"),
